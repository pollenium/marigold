...
var SignedOrdersBatch = /** @class */ (function () {
    function SignedOrdersBatch(struct) {
        ...
        this.signedOrdersByQuotTokenHexVariTokenHex = {};
    ...
    SignedOrdersBatch.prototype.handleSignedOrder = function (signedOrder) {
        return __awaiter(this, void 0, void 0, function () {
            var quotTokenIndex, quotTokenHex, variTokenHex;
            return __generator(this, function (_a) {
                ...
                if (this.signedOrdersByQuotTokenHexVariTokenHex[quotTokenHex][variTokenHex] === undefined) {
                    this.signedOrdersByQuotTokenHexVariTokenHex[quotTokenHex][variTokenHex] = [];
                }
                this.signedOrdersByQuotTokenHexVariTokenHex[quotTokenHex][variTokenHex].push(signedOrder);
                return [2 /*return*/];
            });
        });
    };
